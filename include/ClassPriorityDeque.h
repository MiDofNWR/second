...
private:
	...
	*/
	struct Element
	{
		...
		*/
		Element(const Type& newValue, const int newPriority);
	};
...
template<typename Type>
PriorityDeque<Type>::Element::Element(void) : value(Type()), priority(0) {}

template<typename Type>
PriorityDeque<Type>::Element::Element(const Type& newValue, const int newPriority)
	: value(newValue), priority(newPriority) {}


template<typename Type>
void PriorityDeque<Type>::ERROR(const string text)
{
	cerr << text;
	exit(1);
}
...
template<typename Type>
size_t PriorityDeque<Type>::getMinIndex()
{
	if (count == 0)
	{
		ERROR("Очередь пуста");
...
template<typename Type>
size_t PriorityDeque<Type>::getMaxIndex()
{
	if (count == 0)
	{
		ERROR("Очередь пуста");
...
template<typename Type>
void PriorityDeque<Type>::removeByIndex(const size_t index)
{
	if (index >= count)
	{
...
template<typename Type>
PriorityDeque<Type>::PriorityDeque(void) : data(nullptr), count(0) {}

template<typename Type>
PriorityDeque<Type>::PriorityDeque(initializer_list<pair<Type, int>> other)
...
template<typename Type>
PriorityDeque<Type>::PriorityDeque(list<pair<Type, int>>& other)
	: data(nullptr), count(other.size())
{
	if (count > 0)
	{
...
template<typename Type>
PriorityDeque<Type>::PriorityDeque(const PriorityDeque& other)
...
template<typename Type>
PriorityDeque<Type>::PriorityDeque(PriorityDeque&& other)
...
template<typename Type>
void PriorityDeque<Type>::push(const Type& object, const int priority)
{
...
template<typename Type>
void PriorityDeque<Type>::pop_min()
{
	if (count > 0)
	{
...
template<typename Type>
void PriorityDeque<Type>::pop_max()
{
	if (count > 0)
	{
...
template<typename Type>
Type PriorityDeque<Type>::peek_min()
{
	return data[getMinIndex()].value;
}

template<typename Type>
Type PriorityDeque<Type>::peek_max()
{
	return data[getMaxIndex()].value;
}

template<typename Type>
int PriorityDeque<Type>::priority_min()
{
	return data[getMinIndex()].priority;
}

template<typename Type>
int PriorityDeque<Type>::priority_max()
{
	return data[getMaxIndex()].priority;
}

template<typename Type>
bool PriorityDeque<Type>::empty() const
{
	return count == 0;
}

template<typename Type>
void PriorityDeque<Type>::clear()
{
	delete[] data;
	data = nullptr;
	count = 0;
...
template<typename Type>
size_t PriorityDeque<Type>::printSize() const
{
	return count;
}

template<typename Type>
const void* PriorityDeque<Type>::printData() const
{
	return data;
}

template<typename Type>
ostream& PriorityDeque<Type>::printSize(ostream& os) const
{
	if (count == 0)
	{
...
template<typename Type>
string PriorityDeque<Type>::toString() const
{
	stringstream stream;
	stream << "{";
	for (size_t i = 0; i < count; i++)
...
template<typename Type>
PriorityDeque<Type>& PriorityDeque<Type>::operator=(const PriorityDeque& other)
{
	if (this != &other)
	{
		delete[] data;
...
template<typename Type>
PriorityDeque<Type>& PriorityDeque<Type>::operator=(PriorityDeque&& other)
{
	if (this != &other)
	{
		delete[] data;
...
template<typename Type>
bool PriorityDeque<Type>::operator==(const PriorityDeque& other) const
{
...
template<typename Type>
Type& PriorityDeque<Type>::operator[](const size_t index)
{
	if (index < count)
	{
...
template<typename Type>
const Type& PriorityDeque<Type>::operator[](const size_t index) const
{
	if (index < count)
	{
		return data[index].value;
...
template<typename Type>
int PriorityDeque<Type>::getPriority(const size_t index)
{
	if (index < count)
	{
...
template<typename Type>
PriorityDeque<Type>::~PriorityDeque()
{
	delete[] data;
}
